...
This is a fork of GNUStep's **libobjc2** for deploying as a dual *LLVM Bitcode / ELF Archive* static library. A [CMake build environment](https://github.com/jackoalan/WiiStep) is also available. 
